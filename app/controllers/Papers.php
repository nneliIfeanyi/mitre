...
class Papers extends Controller
{
  ...
  public function edit6th($id)
  {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      if ($updated) {
        flash('msg', 'Updated Successfully');
        redirect('papers/tm_6th_' . $data['mark']->zone . '/' . $data['mark']->mitre_set);
      } else {
        die('Something went wrong..');
      }
    } else {
  ...
  // Term paper version two
  public function tm_6th_ufuma($set)
  {
    ...
    $this->view('papers/tm_6th_ufuma', $data);
  }

  public function tm_6th_kaduna($set)
  {
    ...
    $this->view('papers/tm_6th_kaduna', $data);
  }

  public function tm_6th_minna($set)
  {
    ...
    $this->view('papers/tm_6th_minna', $data);
  }
}
