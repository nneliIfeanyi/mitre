    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <p class="m-0 lead text-primary">Senior Conclave <?php echo SENIOR ?> : <span style='color: green; font-weight: bold; font-size: 18px; text-transform: uppercase;'>
              <?php echo S_CONCLAVE ?>
            </span>
            &nbsp; | &nbsp;Junior Conclave <?php echo JUNIOR ?> : <span style='color: green; font-weight: bold; font-size: 18px; text-transform: uppercase;'><?php echo J_CONCLAVE; ?></span>
          </p>
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          ...
          <a href="<?= URLROOT ?>/admission" class="small-box-footer">Sort New Students <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
    </div>
    <!-- /.row -->
