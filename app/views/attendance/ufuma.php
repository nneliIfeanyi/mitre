  ...
  <div class="container-fluid">
    <div class="card card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="ufuma-table">
          ...
          <tr>
            ...
            <?php if(!$this->attendanceModel->check_attendance($student->id, $first_day, $set, $conclave)):?>
              <!-- CANDIDATE IS ABSENT -->
              <form action="<?php echo URLROOT?>/attendance/ufuma/<?= $set?>" method="post" id="">
            ...
            <?php else:?>
              <div class="d-flex">
                ...
                <!-- REVERSE  ATTENDANCE-->
                <!-- <form action="<?php echo URLROOT?>/attendance/reverse_ufuma" method="post" 
