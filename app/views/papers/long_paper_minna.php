...
<div class="card card-body">
  <nav>
        <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
          ...
          <a href="<?php echo URLROOT?>/papers/long_paper_ufuma/<?php echo $set?>" class="nav-link" 
              id="nav-ufuma-tab" 
              type="button" role="tab" >Ufuma Zone
          </a>
          <a href="<?php echo URLROOT?>/papers/long_paper_minna/<?php echo $set?>" class="active nav-link" 
              id="nav-minna-tab" 
