...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><i class="fab fa-check"></i> Mark Attendance <span class="text-muted"><span class="text-primary">(</span>Minna Set <span class="badge bg-primary"><?php echo $data['set']?></span><span class="text-primary">)</span></span></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="card card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="minna-table">
          ...
          <tr>
            ...
            <?php if(!$this->attendanceModel->check_attendance($student->id, $first_day, $set, $conclave)):?>
              <!-- CANDIDATE IS ABSENT -->
              <form action="<?php echo URLROOT?>/attendance/minna/<?= $set?>" method="post" id="">
            ...
            <?php else:?>
              <div class="d-flex">
                ...
                <!-- REVERSE  ATTENDANCE-->
                <!-- <form action="<?php echo URLROOT?>/attendance/reverse_minna" method="post" 
