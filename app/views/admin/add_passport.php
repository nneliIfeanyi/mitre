            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card card-body bg-light mt-1 mb-5">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo URLROOT; ?>/admin/add_passport/<?= $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                <input type="hidden" name="zone" value="<?= $data['student']->zone; ?>">
                                <input type="hidden" name="set" value="<?= $data['student']->mitre_set; ?>">
                                <input type="file" accept="image/*" name="photo" required class="form-control form-control-lg">
                            </div>
