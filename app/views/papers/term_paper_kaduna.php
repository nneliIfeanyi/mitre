...
<div class="card card-body">
  <nav>
      <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
        <a href="<?php echo URLROOT?>/papers/term_paper_kaduna/<?php echo $set?>" class="active nav-link" 
            id="nav-kaduna-tab" 
        ...
        <a href="<?php echo URLROOT?>/papers/term_paper_minna/<?php echo $set?>" class="nav-link" 
            id="nav-minna-tab" 
