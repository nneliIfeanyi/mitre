  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Ufuma Students Set <span class="badge bg-primary"><?= $data['set'] ?></span></h1>
            <p>A Total of <span class="text-primary"><?php echo $this->databaseModel->totalUfuma($data['set']); ?></span> Registered</p>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card card-body">
          ...
          <nav>
            <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist" style="font-weight: bold;">
              ...
              <a href="<?php echo URLROOT ?>/admin/ufuma/<?php echo $data['set'] ?>" class="active nav-link" id="nav-ufuma-tab" type="button" role="tab">Ufuma Zone
              </a>
