    ...
    <section>
        <div class="container my-5">
            ...
            <?php if (isset($data['step1']->reg_id)) : ?>
                <form method="POST" action="<?= URLROOT; ?>/application/update_step1" data-parsley-validate <?php if (!$isAdmin) echo 'onsubmit="return false;"'; ?>>
                <?php else : ?>
                    <form method="POST" action="<?= URLROOT; ?>/application/step1" data-parsley-validate <?php if (!$isAdmin) echo 'onsubmit="return false;"'; ?>>
                    <?php endif; ?>
